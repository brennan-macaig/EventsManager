...
<html>
    <head>
        ...
        <title>Areas | Events Manager</title>
    ...
    <body>
        ...
        <div class="jumbotron">
            <div class="container">
                <h1>Event Manager</h1>
                <p><strong>Listing areas.</strong> See below so that I can fetch you a list of areas that have been added to our system.</p>
            </div>
        </div>
         <div class="container">
            <hr>
                ...
                <div class="row">
                    ...
                    <div class="alert alert-info" role="alert">
                        <p><strong>Uhh... Huston?</strong> Maybe you haven't added any areas yet! You should go do that if you want to be able to see anything here.<p> 
                    </div>
