<?php
    /*
     ...
     |_____| \_/ \___|_| |_|\__|___/ |_|  |_|\__,_|_| |_|\__,_|\__, |\___|_|   
                                                          |___/           
    delStudent.php written by Brennan Macaig                                                      
...
<html>
    <head>
        ...
        <title>Removing Area... | Events Manager</title>
        ...
        <div class="jumbotron">
            <div class="container">
                ...
                <?php
                    ...
                    if ($result) {
                        echo "<script> window.location.replace('/manager/index?success=delArea')</script>";
                    } else {
                        echo "<script> window.location.replace('/manager/index?failure=delArea')</script>";
                    }
                ?>
            </div>
        </div>
