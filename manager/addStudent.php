...
<html>
    ...
    <body>
        ...
        <div class="jumbotron">
           ...
           <?php
    		if (isset($_POST['register']) && isset($_POST['firstName']) && isset($_POST['lastName']) && isset($_POST['grade'])) {
        		$name = mysql_real_escape_string($_POST['firstName']);
        		$lastname = mysql_real_escape_string($_POST['lastName']);
                $grade = mysql_real_escape_string($_POST['grade']);

        		$registerQuery = mysql_query("INSERT INTO teachers (firstName, lastName, Grade) VALUES ('".$name."', '".$lastname."', '".$grade."')");
    	...
    	<div class="container">
    		<form method="post" action="/manager/addTeacher.php" name="registerform" id="registerform">
        		...
        		<div class="form-group" name="someName" id="someName">
        		    <label for="names">Grade Level</label>
                    <p class="help-block">Please choose "0" for K</p>
                    <select class="form-control" for="grade" id="grade">
